...
//		Vehiculo test = new Vehiculo("Seat", "0567FGR", 2000, ld, "Seat Ibiza", 10000d, "Antonio Miranda", "00000000T");
...
//		
		...
		while (!salir) {
			//CAMBIO-001 Añado la opción Eliminar Vehículo
			...
			case 4:
				System.out.println("Inserta la matricula");
				//CAMBIO-004 Obtengo la matrícula con nextLine y valido la entrada correcta de los kms
				scan.nextLine();
				matricula = scan.nextLine();
				correcto = false;
				while (!correcto) {
